...
public class JdbcTools {
    ...
    private String url = "jdbc:mysql://localhost:3306/bcos?useUnicode=true&characterEncoding=UTF8&zeroDateTimeBehavior=convertToNull&serverTimezone=Asia/Shanghai";
    ...
    public static void main(String[] args) {
        ...
        List<Map<String, Object>> list = tools.select("select * from user");
